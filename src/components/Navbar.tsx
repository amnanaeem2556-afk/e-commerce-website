        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
              ...
              >
                <span className="font-serif text-xl sm:text-2xl lg:text-3xl tracking-[0.18em] sm:tracking-[0.25em] text-[#C48A5A] font-semibold transition-transform duration-300 group-hover:scale-[1.02] leading-tight">
                  LUMORA
                </span>
